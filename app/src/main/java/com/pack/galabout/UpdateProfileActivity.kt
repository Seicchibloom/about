...
class UpdateProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize views
        editTextUsername = findViewById(R.id.editTextTextPersonUsername)
        editTextName = findViewById(R.id.editTextTextPersonName)
        editTextTitle = findViewById(R.id.editTextTextPersonTitle)
        editTextBirthdate = findViewById(R.id.editTextTextPersonBirthdate)
        editTextResidency = findViewById(R.id.editTextTextPersonResidency)
        buttonSaveChanges = findViewById(R.id.buttonSaveChanges)
        buttonCancel = findViewById(R.id.buttonCancel)
        buttonEditAvatar = findViewById(R.id.buttonEditAvatar)
        imageViewEditAvatar = findViewById(R.id.imageViewEditAvatar)
